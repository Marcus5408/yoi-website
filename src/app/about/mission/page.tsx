    ...
    <div className="flex min-h-screen w-full flex-col items-center justify-between bg-yoi-white dark:bg-yoi-black">
      <main className="z-1 flex-1">
        <Banner
          ...
          size="medium"
          title="For the Ocean."
          description="YOI aims to provide young individuals from all around the
            globe, regardless of their background, with opportunities to expand
            their knowledge, gain experience in youth-led advocacy, access
            resources, and collaborate with others in all fields relating to
            our ocean."
        />
