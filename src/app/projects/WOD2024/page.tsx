              ...
              <Card className="md:table-cell md:w-1/3">
                ...
                <CardContent>
                  <CardDescription className="text-center">
                    Kevin is a rising high school senior from Brooklyn, New
                    York. He believes ocean preservation and protecting the
                    ocean from Kevin is a rising high school senior from
                    Brooklyn, New York. He believes ocean preservation and
                    protecting the ocean from man-made pollutants is crucial for
                    the health of the ocean as well as our wellbeing. He fights
                    for the preservation of the ocean through creating art.
                  </CardDescription>
                </CardContent>
              </Card>
              <Card className="md:table-cell md:w-1/3">
                ...
                <CardContent>
                  <CardDescription className="text-center">
                    ...
                    feelings of simplicity and overwhelmed. She believes that
                    the ocean is grand and untouchable. She hopes her
                    photography is able to show how this grand beauty interacts
